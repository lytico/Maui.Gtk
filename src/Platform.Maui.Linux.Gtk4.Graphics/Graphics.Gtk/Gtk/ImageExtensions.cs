...
public static class ImageExtensions {
    ...
    public static GdkPixbuf.Pixbuf? SaveToStream (this Cairo.ImageSurface? surface, Stream stream, ImageFormat format = ImageFormat.Png, float quality = 1) {
        if (surface == null)
            return null;
        try {
    ...
    public static bool SaveToStream (this GdkPixbuf.Pixbuf? pixbuf, Stream stream, ImageFormat format = ImageFormat.Png, float quality = 1) {
        if (pixbuf == null)
            return false;
    ...
    public static GdkPixbuf.Pixbuf? CreatePixbuf (this Cairo.ImageSurface? surface) {
        if (surface == null)
            return null;
        ...
        return new GdkPixbuf.Pixbuf (pixData, Gdk.Colorspace.Rgb, nbytes == 4, 8, surface.Width, surface.Height, surface.Width * nbytes, null);
    }

    public static Cairo.Pattern? CreatePattern (this GdkPixbuf.Pixbuf? pixbuf, double scaleFactor) {
        if (pixbuf == null)
            return null;
    ...
    public static void DrawPixbuf (this Cairo.Context context, GdkPixbuf.Pixbuf pixbuf, double x, double y, double width, double height) {
        context.Save ();
