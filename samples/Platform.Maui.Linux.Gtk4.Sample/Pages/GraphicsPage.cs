	...
	public GraphicsPage()
	{
		...
		Content = new ScrollView
		{
			Content = new VerticalStackLayout
			{
				...
				Children =
				{
					new Label { Text = "GraphicsView (Cairo)", FontSize = 24, FontAttributes = FontAttributes.Bold },
...
class CompositeDrawable : IDrawable
{
	public void Draw(ICanvas canvas, RectF rect)
	{
		...
		canvas.DrawString("Cairo Rendering Engine", 250, 40, HorizontalAlignment.Left);
