...
class ThemePage : ContentPage
{
	...
	public ThemePage()
	{
		...
		themedLabel.SetAppThemeColor(Label.BackgroundColorProperty,
			Color.FromArgb("#E8E8E8"), Color.FromArgb("#333333"));
		...
		var lightBtn = new Button { Text = "☀️ Force Light" };
		...
		var systemBtn = new Button { Text = "🖥️ Follow System" };
		...
		Content = new ScrollView
		{
			Content = new VerticalStackLayout
			{
				...
				Children =
				{
					...
					new Label
					{
						Text = "Switch between light and dark modes, or follow the system theme.",
